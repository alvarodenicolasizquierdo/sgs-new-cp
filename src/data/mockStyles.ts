...
export const mockStyles: Style[] = [
  {
    ...
    orderQuantity: 5000,
    washedProduct: false,
    careSymbols: [mockCareSymbols[1], mockCareSymbols[6], mockCareSymbols[7], mockCareSymbols[10]],
  ...
  },
  {
    ...
    careSymbols: [mockCareSymbols[1], mockCareSymbols[6], mockCareSymbols[9], mockCareSymbols[13]],
    careWording: [mockCareWording[1], mockCareWording[3], mockCareWording[5], mockCareWording[7]],
  ...
  },
  {
    ...
    careSymbols: [mockCareSymbols[2], mockCareSymbols[6], mockCareSymbols[8], mockCareSymbols[11]],
    careWording: [mockCareWording[1], mockCareWording[3], mockCareWording[4], mockCareWording[6]],
    componentIds: ["comp-6"],
    images: [
  ...
  },
  {
    ...
    careSymbols: [mockCareSymbols[1], mockCareSymbols[6], mockCareSymbols[7], mockCareSymbols[11]],
    careWording: [mockCareWording[1], mockCareWording[3], mockCareWording[4], mockCareWording[6]],
  ...
  },
  {
    ...
    orderQuantity: 2500,
    washedProduct: false,
    careSymbols: [mockCareSymbols[0], mockCareSymbols[6], mockCareSymbols[9], mockCareSymbols[10]],
    careWording: [mockCareWording[0], mockCareWording[3], mockCareWording[5], mockCareWording[6]],
    componentIds: ["comp-9"],
    images: [],
  ...
  },
  {
    ...
    orderQuantity: 6000,
    washedProduct: false,
    careSymbols: [mockCareSymbols[1], mockCareSymbols[6], mockCareSymbols[8], mockCareSymbols[13]],
